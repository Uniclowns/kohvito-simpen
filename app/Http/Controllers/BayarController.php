...
class BayarController extends Controller
{
     ...
     *
     * @param  Request  $request  Data request checkout
     */
     ...
     *
     * @param  Request  $request  Data form hasil simulasi
     * @param  string  $noPesanan  Nomor transaksi referensi
     */
     ...
     *
     * @param  Pesanan  $pesanan  Model pesanan aktif
     */
     ...
     *
     * @param  Request  $request  Payload callback dari gateway
     */
     ...
     *
     * @param  Request  $request  Objek HTTP request untuk validasi header
