...
{{-- Header: filter icon + Tutup/Buka Order button --}}
@section('header-end')
<div class="flex items-center gap-3">
    <button type="button" class="w-9 h-9 flex items-center justify-center rounded-lg border border-brand-gray-extralight hover:bg-brand-light transition-colors">
    ...
    <form action="{{ route('admin.toggle-order-status') }}" method="POST">
        ...
        <button type="submit"
                class="flex items-center gap-2 px-4 py-2 rounded-lg text-sm font-semibold transition-colors
                    {{ $orderStatus === 'buka' ? 'bg-brand-red text-white hover:bg-brand-dark' : 'bg-green-600 text-white hover:bg-green-700' }}">
            @if ($orderStatus === 'buka')
...
<div class="grid grid-cols-2 gap-4 mb-5">
    ...
    {{-- Makanan Terlaris --}}
    <div class="bg-white rounded-xl border border-brand-gray-extralight shadow-sm px-5 py-4 flex items-center justify-between">
        <div>
            ...
            <p class="text-base font-bold text-brand-black mt-2">
        ...
        @else
            <div class="w-20 h-20 rounded-lg bg-brand-light flex items-center justify-center flex-shrink-0">
                <svg class="w-8 h-8 text-brand-gray-light" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <table class="w-full text-sm">
            ...
            <tbody class="divide-y divide-brand-gray-extralight">
                ...
                <tr class="hover:bg-brand-light/40 transition-colors">
                    ...
                    <td class="px-4 py-3 text-brand-gray whitespace-nowrap">
                        {{ $p->tgl_pembayaran?->format('H:i') }}
                    </td>
                    ...
                    <td class="px-4 py-3 font-medium text-brand-black whitespace-nowrap">
...
<footer class="bg-white border-t border-brand-gray-extralight mt-2">
    ...
    <div class="border-t border-brand-gray-extralight px-8 py-4 text-center">
        <p class="text-xs text-brand-gray">
            &copy;{{ date('Y') }} All Rights Reserved. Developed By Pet &amp; John
        </p>
    </div>
</footer>
@endsection
...
(function () {
    ...
    // Bar chart — Pendapatan Minggu Ini
