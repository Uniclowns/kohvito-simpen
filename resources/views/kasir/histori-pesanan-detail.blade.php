...
<head>
    ...
    <title>Detail Histori — {{ config('app.name') }}</title>
    @vite(['resources/css/app.css', 'resources/js/app.js'])
</head>
<body class="bg-gray-50 min-h-screen">
    <nav class="bg-white border-b border-gray-200 px-6 py-4 flex items-center gap-4">
        <a href="{{ route('kasir.histori.index') }}" class="text-sm text-gray-500 hover:text-gray-700">← Histori Pesanan</a>
        <h1 class="text-lg font-semibold text-gray-900">Detail Histori</h1>
    </nav>
