...
<footer class="bg-brand-dark px-10 py-12 mt-auto">
    <div class="grid grid-cols-12 gap-8 border-b border-white/10 pb-8">
        ...
        <div class="col-span-2">
            ...
            <ul class="space-y-4">
                <li>
                    <a href="{{ route('kasir.beranda') }}" class="text-[18px] text-white/80 hover:text-white transition-colors">Beranda Kasir</a>
                </li>
                <li>
                    <a href="{{ route('kasir.pesanan.index') }}" class="text-[18px] text-white/80 hover:text-white transition-colors">Kelola Pesanan</a>
                </li>
                <li>
                    <a href="{{ route('kasir.histori.index') }}" class="text-[18px] text-white/80 hover:text-white transition-colors">Histori Pesanan</a>
                </li>
            </ul>
        </div>
